                        ...
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse" id="collapseUtilities" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="generateInvoice">Create Invoice</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                            ...
                            <!-- edit-->
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">Manage Invoice</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">Manage Invoice
                                <div class="col-sm-12">
                                    <div class="column" style="float: right;">
                                        <a href="generateInvoice" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i>Generate Invoice </a>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="dataTable-container">
                                    <table id="datatablesSimple" class="dataTable-table">
                                        ...
                                        <thead>
                                            ...
                                            <th>Amount</th>
                                            <th>Action</th>  
                                            <!-- <th data-sortable="" style="width: 12.7869%;"><a href="#" class="dataTable-sorter">Actions</a></th> -->
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="Show Job Information">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a href="" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="left" title=""
                                                        data-original-title="Invoice"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
                                                    <a href="" class="btn btn-info btn-xs" onclick="is_recurring('3786922837', '128') "
                                                        data-toggle="tooltip" data-placement="top" title="Is Recurring Invoice"><i class="fa fa-repeat"> </i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>1</td>
