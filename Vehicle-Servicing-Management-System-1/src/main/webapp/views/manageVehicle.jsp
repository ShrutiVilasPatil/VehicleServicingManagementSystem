            ...
            <div id="layoutSidenav_content">
                <main>
                            ...
                            <!-- edit-->
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">Manage Vehicles</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">Manage Vehicles
                                <div class="col-sm-12">
                                    <div class="column" style="float: right;">
                                        <a href="addVehicle1" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> Add New Vehicles </a>
                                    </div>
                                </div>
                                <div class="col-sm-12">
