...
<body>
	<nav
		...
		<a class="navbar-brand pe-3 ps-4 ps-lg-2" href="index.html"><img
			src="/resources/assets/img/logo.png" />VSMS</a>
		<!-- Navbar Search Input-->
		...
		<ul class="navbar-nav align-items-center ms-auto">
			...
			<li
				...
				<div
					...
					<a class="dropdown-item dropdown-notifications-item" href="#!">
						...
						src="/resources/assets/img/illustrations/profiles/profile-2.png" />
						<div class="dropdown-notifications-item-content">
					...
					<a class="dropdown-item dropdown-notifications-item" href="#!">
						<img class="dropdown-notifications-item-img"
						src="/resources/assets/img/illustrations/profiles/profile-3.png" />
						<div class="dropdown-notifications-item-content">
							<div class="dropdown-notifications-item-content-text">Lorem
								ipsum dolor sit amet, consectetur adipisicing elit, sed do
								eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
					...
					<a class="dropdown-item dropdown-notifications-item" href="#!">
						<img class="dropdown-notifications-item-img"
						src="/resources/assets/img/illustrations/profiles/profile-4.png" />
						<div class="dropdown-notifications-item-content">
							<div class="dropdown-notifications-item-content-text">Lorem
								ipsum dolor sit amet, consectetur adipisicing elit, sed do
								eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
					...
					<a class="dropdown-item dropdown-notifications-item" href="#!">
						<img class="dropdown-notifications-item-img"
						src="/resources/assets/img/illustrations/profiles/profile-5.png" />
						<div class="dropdown-notifications-item-content">
							<div class="dropdown-notifications-item-content-text">Lorem
								ipsum dolor sit amet, consectetur adipisicing elit, sed do
								eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
			...
			<li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
				...
				aria-expanded="false"><img class="img-fluid"
					src="/resources/assets/img/illustrations/profiles/profile-1.png" /></a>
				<div
					class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
					aria-labelledby="navbarDropdownUserImage">
					<h6 class="dropdown-header d-flex align-items-center">
						<img class="dropdown-user-img"
							src="/resources/assets/img/illustrations/profiles/profile-1.png" />
			...
			<nav class="sidenav shadow-right sidenav-light">
				<div class="sidenav-menu">
					<div class="nav accordion" id="accordionSidenav">
						...
						</a> <br> <a class="nav-link active" href="#">
							<div class="nav-link-icon">
								<i data-feather="activity"></i>
							</div> Dashboard
						</a>
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sidenav-menu-nested nav accordion"
								...
								<a class="nav-link" href="pricing.html">Add Customer</a> <a
									class="nav-link" href="invoice.html">Manage Customer</a>
								<div class="collapse" id="pagesCollapseAccount"
									data-bs-parent="#accordionSidenavPagesMenu"></div>
						...
						<div class="collapse" id="collapseApps"
							...
							<nav class="sidenav-menu-nested nav accordion"
								...
								<a class="nav-link" href="addVehicle1">Add Vehicle</a> <a
									class="nav-link" href="manageVehicle">Manage Vehicle</a>
							</nav>
						</div>
						...
						<div class="collapse" id="collapseFlows"
							...
							<nav class="sidenav-menu-nested nav">
								<a class="nav-link" href="#">Add Job Card</a> <a
									class="nav-link" href="#">Manage Job Card</a> <a
									class="nav-link" href="#">Gate Pass</a>
							</nav>
						</div>
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sidenav-menu-nested nav accordion"
								...
								<a class="nav-link" href="multi-tenant-select.html">Add
									Employee</a> <a class="nav-link" href="wizard.html">Manage
									Employee</a>
							</nav>
						</div>
						...
						<div class="collapse" id="collapseUtilities"
							...
							<nav class="sidenav-menu-nested nav">
								...
								<a class="nav-link" href="animations.html">Create Invoice</a> <a
									class="nav-link" href="background.html">Manage Invoice</a>
						...
						<div class="collapse" id="collapseComponents"
							...
							<nav class="sidenav-menu-nested nav">
								...
								<a class="nav-link" href="#">Vehicle Report</a> <a
									class="nav-link" href="#">Invoice Report</a> <a
									class="nav-link" href="#">Employee Report</a>
							</nav>
						</div>
