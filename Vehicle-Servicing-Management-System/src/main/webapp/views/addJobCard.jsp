            ...
            <div id="layoutSidenav_content">
                <main>
                            ...
                            <!-- edit-->
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle"> Add Job Order</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">Add Job Order
                                <div class="col-sm-12">
                                    <div class="column" style="float: right;">
                                        <a href="manageVehicle" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> Manage Jobs </a>
                        ...
                        <div class="card-body">
                          ...
                          <form>
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputCustomerName">Customer <i class="text-danger"> *</i></label>
                                ...
                                <div class="col-md-6">
                                  <label class="small mb-1" for="inputYear">Work Order No</label>
                            ...
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (Year)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputYear">Address</label>
                                    <input class="form-control" id="inputYear" type="text"  />
                                </div>
                                <!-- Form Group (Seats)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputSeats">Vehicle Reg No</label>
                                   <select class="form-select" aria-label="Default select example">
                                        <option selected disabled>Select option</option>
                                        <option value="administrator">V101</option>
                                        <option value="registered">V102</option>
                                        <option value="edtior">V103</option>
                                        <option value="guest">V104</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (Mark)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputMark">Mobile</label>
                                    <input class="form-control" id="inputMark" type="number"  />
                                </div>
                                <!-- Form Group (CC Rating)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputSecondColour">Details</label>
                                    <input class="form-control" id="inputSecondColour" type="text" />
                                </div>
                            </div>
                            ...
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (Model)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputAssemblyType">Delivery Date</label>
                                    <input class="form-control" id="inputAssemblyType" type="text" placeholder="Delivery Date" />
                                </div>
                                <!-- Form Group (Fuel Type)-->
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputFuelType">Schedule Date</label>
                                    <input class="form-control" id="inputModel" type="text"  placeholder="Schedule Date" />
                                </div>
                            </div>
