...
<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <div class="container-xl px-4 mt-4">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                       <form:form action="/saveNewCust" method="post" modelAttribute="customer">
                                            <div class="row gx-3 mb-3">
                                                <!-- Form Group (first name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1">First name</label>
                                                    <form:input class="form-control"  path="customerFName" placeholder="Enter your first name" />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1">Last name</label>
                                                    <form:input class="form-control" path="customerLName" placeholder="Enter your last name"/>
                                                </div>
                                            </div>
                                            <!-- Form Row        -->
                                            <div class="row gx-3 mb-3">
                                                <!-- Form Group (organization name)-->
                                                 <div class="col-md-6">
                                                    ...
                                                    <form:input class="form-control" path="customerDOB" placeholder="Enter your birthday" />
                                                </div>
                                                <!-- Form Group (location)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1">Mobile No</label>
                                                    <form:input class="form-control" path="customerMo" placeholder="Enter your Mobile No"  />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gx-3 mb-3">
                                              <div class="col-md-6">
                                                  ...
                                                  <form:input class="form-control" path="customerEmail" placeholder="Enter your email address" />
                                                </div>
                                             <div class="col-md-6">
                                                 <label class="small mb-1" >Gender</label>
                                                  <form:select  path="customerGender" class="form-select" >
                                              ...
                                              <div class="row gx-3 mb-3">
                                                <!-- Form Group (first name)-->
                                                <label class="small mb-1">Address Detalis</label>
                                                <div class="col-md-6">
                                                    <label class="small mb-1">Country</label>
                                                    <form:input class="form-control" path="customer_Country" placeholder="Enter your Country" />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1">State</label>
                                                    <form:select path="customer_State" class="form-select" >
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form:input class="form-control" path="customer_City" placeholder="Enter your City" />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1">Address</label>
                                                    <form:input class="form-control" path="customer_Address" placeholder="Enter your address"/>
                                                </div>
                                            </div>
                                            <!-- Save changes button-->
