                            ...
                            <!-- edit-->
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle"> Add New Customer</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                       <form action="" method="post" modelAttribute="customer">
                                            <div class="row gx-3 mb-3">
                                                <!-- Form Group (first name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1">First name</label>
                                                    <input class="form-control" path="customerFName" placeholder="Enter your first name" />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputLastName">Last name</label>
                                                    <input class="form-control" id="inputLastName" path="customerLName" type="text" placeholder="Enter your last name"/>
                                                </div>
                                            </div>
                                            <!-- Form Row        -->
                                            <div class="row gx-3 mb-3">
                                                <!-- Form Group (organization name)-->
                                                 <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputBirthday" path="customerDOB" type="text" name="birthday" placeholder="Enter your birthday" />
                                                </div>
                                                <!-- Form Group (location)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputmobile">Mobile No</label>
                                                    <input class="form-control" id="inputmobile" path="customerMo" type="text" placeholder="Enter your Mobile No"  />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gx-3 mb-3">
                                              <div class="col-md-6">
                                                  ...
                                                  <input class="form-control" id="inputEmailAddress" path="customerEmail" type="email" placeholder="Enter your email address" value="name@example.com" />
                                                </div>
                                              <div class="col-md-6">
                                                 <label class="small mb-1" >Gender</label>
                                                  <select  path="customerGender" class="form-select" >
                                              ...
                                              <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputcountry" path="customer_Country" type="text" placeholder="Enter your Country" />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputstate">State</label>
                                                    <select class="form-select" path="customer_State" aria-label="Default select example" >
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputcity" path="customer_City" type="text" placeholder="Enter your City" />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputaddress">Address</label>
                                                    <input class="form-control" id="inputaddress" path="customer_Address" type="text" placeholder="Enter your address"/>
                                                </div>
                                            </div>
                                            <!-- Save changes button-->
