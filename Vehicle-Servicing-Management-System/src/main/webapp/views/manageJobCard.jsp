            ...
            <div id="layoutSidenav_content">
                <main>
                            ...
                            <!-- edit-->
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">Manage Job Card</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">Manage Job
                                <div class="col-sm-12">
                                    <div class="column" style="float: right;">
                                        <a href="addVehicle1" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> Add Job Order </a>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a onclick="return confirm('Do you want to delete it?')" class="btn btn-sm btn-danger"><i data-feather="trash-2"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>John</td>
                                                <td>125647</td>
                                                <td>2022-09-13 05:35:00</td>
                                                <td>2022-09-20 02:12:00</td>
                                                <td>Accept</td>
                                                <td>2 Pending</td>
                                                <td class="text-center">
                                                    <a  class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>Hari</td>
                                                <td>KL 52 j 6421</td>
                                                <td>2022-08-30 02:35:00</td>
                                                <td>2022-08-30 15:37:00</td>
                                                <td>Completed</td>
                                                <td>2 Complete</td>
                                                <td class="text-center">
                                                    <a  class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
