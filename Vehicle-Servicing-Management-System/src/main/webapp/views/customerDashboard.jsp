...
<body>
		<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
            ...
            <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="customerDashboard"><img src="/resources/assets/img/logo.png"/>VSMS</a>
            <!-- Navbar Search Input-->
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link active" href="customerDashboard">
                            ...
                            <div class="collapse" id="collapseFlows" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav">
                                    <a class="nav-link" href="addJobCard">Book Servicing</a>
                                    <a class="nav-link" href="manageJobCard">Manage Servicing</a>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-8 col-xxl-12">
                                                <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                                    ...
                                                    <p class="text-gray-700 mb-0">You can book servicing and manage vehicles</p>
                                                </div>
                                            </div>
                                ...
                                <div class="card bg-primary text-white h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-white-75 small">Total Vehicles</div>
                            ...
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-success text-white h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-white-75 small">Completed Servicing</div>
                                                <div class="text-lg fw-bold">2</div>
                                            </div>
                            ...
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-danger text-white h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-white-75 small">Ongoing Servicing</div>
                                                <div class="text-lg fw-bold">1</div>
                                            </div>
